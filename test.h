/* test.h
   Generated by wsdl2h 2.8.7 from test.wsdl and typemap.dat
   2013-09-24 13:40:34 GMT
 ...
 *                                                                            *
 * Definitions                                                                *
 *   http://95.154.243.111/~ws/pos/test.wsdl                                  *
 *                                                                            *
\******************************************************************************/
...
ns1 = "http://95.154.243.111/~ws/pos/test.wsdl"
ns2 = "urn:poc"
ns2 = "urn:poc"
...
/// Primitive built-in type "xs:DataTableType"
...
/// @brief Reference to specific bibliographic items.
   @_ns2__sourceRef*                     ns2__sourceRef                 0;	///< Optional attribute.
/// Attribute reference "":methodRef.
/// @brief Reference to a specific method.
   @_ns2__methodRef*                     ns2__methodRef                 0;	///< Optional attribute.
...
/// @brief Description of physical units. Use "unitless" for dimensionless quantities.
   @enum _ns2__units                     ns2__units                     1;	///< Required attribute.
...
class ns2__ReactantsType
{ public:
/// SEQUENCE OF ELEMENTS <xs:sequence minOccurs="2" maxOccurs="unbounded">
    std::vector<                                                       
...
/// Attribute reference "":sourceID.
   @_ns2__sourceID                       ns2__sourceID                  1;	///< Required attribute.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};
...
/// @brief ID for a specific method
   @_ns2__methodID                       ns2__methodID                  1;	///< Required attribute.
/// Attribute reference "":sourceRef.
/// @brief Reference to specific bibliographic items.
   @_ns2__sourceRef*                     ns2__sourceRef                 0;	///< Optional attribute.
/// Attribute reference "":functionRef.
/// @brief Reference to a specific fit function
   @_ns2__functionRef*                   ns2__functionRef               0;	///< Optional attribute.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};
...
{ public:
/// Begin group .
/// Begin group HyperfineCouplingISum.
...
//  END OF CHOICE
/// End of group HyperfineCouplingISum.
/// End of group .
/// Element TotalAngularMomentumF of type "":ComplexMolecularQuantumNumberType.
    ns2__ComplexMolecularQuantumNumberType*  TotalAngularMomentumF          1;	///< Required element.
/// Element TotalMagneticQuantumNumberF of type "":MagneticQuantumNumberType.
...
/// @brief ID for a specific state/particle.
   @_ns2__stateID                        ns2__stateID                   1;	///< Required attribute.
...
/// Element reference "":NonRadiative.
    ns2__NonRadiativeType*               ns2__NonRadiative              0;	///< Optional element.
...
/// @brief ID for a specific function
   @_ns2__functionID                     ns2__functionID                1;	///< Required attribute.
};
...
//gsoap ns2  service port:	http://95.154.243.111/~ws/pos/testserver.cgi 
...
@section poc_ports Endpoints of Binding  "poc"
  ...
  - http://95.154.243.111/~ws/pos/testserver.cgi
...
Service definition of function ns__getS
  ...
  - Addressing action: "http://95.154.243.111/~ws/pos/test.wsdl/pocPortType/getSRequest"

  - Addressing response action: "http://95.154.243.111/~ws/pos/test.wsdl/pocPortType/getSResponse"
...
//gsoap ns2  service method-output-action:	getS http://95.154.243.111/~ws/pos/test.wsdl/pocPortType/getSResponse
int ns2__getS(
    std::string                         species1,	///< Request parameter
    std::string                         species2,	///< Request parameter
    unsigned int                        s,	///< Request parameter
    double                              x0,	///< Request parameter
    double                              Tmin,	///< Request parameter
    double                              Tmax,	///< Request parameter
    double                              Npoints,	///< Request parameter
    bool                                logaritmic,	///< Request parameter
    xsd__DataTableType                 &dat	///< Response parameter
);
